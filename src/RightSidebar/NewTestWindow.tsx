...
savedBody?: string;
  ...
  <div className="flex justify-end items-center pb-4 mr-4 space-x-4">
        ...
        <Button text="Save" onClick={saveTest} className="mt-2 inline-flex justify-center rounded-md border border-gray-600 shadow-sm px-4 py-2 bg-[#44464f] text-base font-medium text-white hover:bg-[#525363]  sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" />
        </div>
</div>
