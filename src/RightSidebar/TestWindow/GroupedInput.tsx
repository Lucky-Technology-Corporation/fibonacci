...
export default function GroupedInput({
  ...
  valueList: { id: number; key: string; value: string }[];
  setValueList: Dispatch<SetStateAction<object[]>>;
  isQuery: boolean;
}) {
      ...
      <div className="flex w-full" key="empty-row">
        ...
        <input
          ...
          onBlur={() => {
            ...
            setValueList([...valueList, { id: valueList.length, key: emptyRow.key, value: emptyRow.value }]);
