                ...
                toast={{
                    ...
                    content: (
                        ...
                        <div className='h-4'></div>Otherwise, you can access the following properties:
                            {getTableHelper([
                                {name: "UID(request.user)", description: "Swizzle UID"},
                                {name: "request.user.createdAt", description: "Date"},
                                {name: "request.user.isAnonymous", description: "boolean"}
                            ])}
                            and these (but they might be null!)
                            {getTableHelper([
                                {name: "request.user.username", description: "string"},
                                {name: "request.user.email", description: "string"},
                                {name: "request.user.phoneNumber", description: "string (E.164)"}
                            ])}
                        </div>
                    )
                }}
