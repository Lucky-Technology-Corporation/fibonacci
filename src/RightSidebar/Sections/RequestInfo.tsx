        ...
        <InfoItem
          ...
          content={
            <>
              ...
              <div className="ml-2 text-xs font-mono">request</div>
            </>
          }
          toast={{
            title: "request",
                  ...
                  [
                    {
                      ...
                      description: "Query variables (?queryVariable=value)",
                    },
                    {
                      name: "request.params.pathVariable",
                      description: "Path variables (/api/:pathVariable)",
                    },
                    {
                      name: "request.body",
                      description: "Body object (whatever is sent in the body)",
                    },
                  ],
                  handleRowClick,
                )}
        ...
        <InfoItem
          ...
          content={
            <>
              ...
              <div className="ml-2 text-xs font-mono">response</div>
            </>
          }
          toast={{
            title: "response",
              ...
              <div className="text-gray-400">
                ...
                {GetTableHelper(
                  [
                    {
                      name: "response.send({})",
                      description: "Send an object back to the frontend",
                    },
                    {
