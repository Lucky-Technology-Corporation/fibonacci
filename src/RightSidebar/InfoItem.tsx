export default function InfoItem({title, showHintWindow, hideHintWindow}: {title: string, showHintWindow: () => void, hideHintWindow: () => void}) {
    return (
        <div className='py-1 flex items-center mt-1 cursor-pointer'
            ...
            <div className='ml-2 text-sm font-mono'>{title}</div>
