        ...
        <tbody className="overflow-y-scroll">
          <tr className="border-b border-[#4C4F6B] h-[40px] hover:bg-[#85869855]">
            ...
            <td className="text-left pl-4">
              <HoverableObject text={"Object"} object={{}} /> from user{" "}
              <HoverableObject text={"sI82nd82n9923"} object={{}} />
            </td>
            <td className="text-left pl-4">
              {" "}
              <HoverableObject text={"Object"} object={{}} /> with status 200
            </td>
          ...
          <tr className="border-b border-[#4C4F6B] h-[40px] hover:bg-[#85869855]">
            ...
            <td className="text-left pl-4">
              {" "}
              <HoverableObject text={"Error"} object={{}} /> with status 500
            </td>
            <td className="w-24 pr-2">
              <Button text="Retry" onClick={() => {}} />
            </td>
