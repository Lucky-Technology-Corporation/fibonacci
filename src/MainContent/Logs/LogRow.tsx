...
export default function LogRow(){
    ...
    return (
        <>
        <tr className={`${isExpanded ? "border-none" : "border-b"} border-[#4C4F6B] h-[48px] hover:bg-[#85869855] cursor-pointer`} onClick={() => { setIsExpanded(!isExpanded)}}>
            ...
            <td className="text-left pl-4 font-bold"><div className="flex"><Dot color={"green"} className="ml-0 mr-2" /><div>200</div></div></td>
            ...
            <td className="text-right pl-4">
                <ArrowRightIcon className={`w-6 h-6 ml-auto mr-2 ${isExpanded ? "rotate-90" : "rotate-0"}`} style={{transition: "transform .2s"}}/>
            </td>
        </tr>
