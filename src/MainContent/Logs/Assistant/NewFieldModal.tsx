...
export default function NewFieldModal({addFieldHandler, addVisible, setAddVisible, collectionName, keyPath}: {addFieldHandler: any, addVisible: boolean, setAddVisible: any, collectionName: string, keyPath: string[]}){
  ...
  const primitives = [
    {"id": "string", "name": "string"}, {"id": "number", "name": "number"}, {"id": "boolean", "name": "boolean"}, {"id": "object", "name": "object"}, {"id": "date", "name": "date"}
  ]
  ...
  return (
    <div
        className={`absolute top-0 left-0 w-full h-full z-50 overflow-y-auto ${addVisible ? "opacity-100" : "opacity-0 pointer-events-none"}`}
    ...
    <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="bg-[#32333b] px-4 pt-5 pb-2 sm:p-6 sm:pb-4 rounded-lg">
            ...
            <div className="mt-4 mb-4 flex no-focus-ring h-8">
                <input type="text" className="px-2 w-full mr-4 ml-[-4px] h-[36px] bg-[#252629] border-[#525363] text-xs font-mono font-semibold rounded mx-0" placeholder="Field name" value={fieldName} onChange={
