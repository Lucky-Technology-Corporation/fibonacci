            ...
            <div>
              ...
              <div className="mt-0.5 flex">
                ...
                <div className="font-bold flex">
                  <img src="database.svg" className="w-3 h-3 my-auto ml-1.5 mr-1" />
                  Database
                </div>
                , access
                <div className="font-bold flex">
                  <img src="files.svg" className="w-3 h-3 my-auto ml-1.5 mr-1" />
                  Files
                </div>
                ...
                <div className="flex flex-col leading-normal mb-0.5" key={taskIndex}>
                  <div className="flex flex-col justify-center items-center">
                    <Task
                      ...
                      task={task}
                      removeTask={() => {
                        removeTaskFromMessage(0, taskIndex);
                      }}
                      editTask={(newTask: any) => {
                        editTaskInMessage(0, taskIndex, newTask);
                      }}
          ...
          <div>
            <div className="flex">
              <div className="w-full grow">
                ...
                <div className="mt-0.5 flex">Code that runs in the browser and generates UI</div>
              </div>
            </div>
          </div>
        </div>
