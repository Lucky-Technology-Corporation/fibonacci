      ...
      <div className="flex flex-col items-center justify-center h-full mr-4">
        ...
        <div className="flex flex-col items-center justify-center mt-4">
          <div>
            ...
            <input className="w-96 bg-transparent border-[#525363] w-80 border rounded outline-0 focus:border-[#68697a] mt-1 p-2" value={appId} onChange={(e) => {setAppId(e.target.value)}} />
          </div>
          <div>
            <div className="text-sm font-medium mt-4">Expiry</div>
            <div className="text-sm text-gray-400 mb-1">Hours a user can stay signed in without re-authenticating</div>
            <input className="w-96 bg-transparent border-[#525363] w-80 border rounded outline-0 focus:border-[#68697a] mt-1 p-2" value={expiry} onChange={(e) => {setExpiry(e.target.value)}} />
          </div>
    ...
    <div className="ml-4">
        <div className="flex flex-col items-top justify-left">
          <div className="text-center">
            ...
            {method == "google" && (
              <div className="text-sm text-gray-400 mb-1">Paste these values <b>into</b> the <a href='https://console.cloud.google.com/apis/credentials' target='_blank'>Google Cloud Console</a></div>
            )}
            {method == "facebook" && (
              <div className="text-sm text-gray-400 mb-1">Paste these values <b>into</b> the <a href='https://developers.facebook.com/apps' target='_blank'>Facebook Developer Portal</a></div>
            )}
          </div>
          ...
          {method == "google" && (
            ...
            <div className="w-96 bg-transparent border-[#525363] border rounded outline-0 focus:border-[#68697a] p-2 mt-1 truncate cursor-pointer" onClick={() => {copyText(`${testDomain}`)}}>
              {testDomain}
            </div>
            <div className="w-96 bg-transparent border-[#525363] border rounded outline-0 focus:border-[#68697a] p-2 mt-2 truncate cursor-pointer" onClick={() => {copyText(`${prodDomain}`)}}>
              {prodDomain}
            </div>
            </>
          )}
        ...
        <div className="flex flex-col items-top justify-left">
          ...
          <div className="w-96 bg-transparent border-[#525363] border rounded outline-0 focus:border-[#68697a] p-2 mt-1 truncate cursor-pointer" onClick={() => {copyText(`${testDomain}/d/auth/${method}`)}}>
            {testDomain}/d/auth/{method}
          </div>
          <div className="w-96 bg-transparent border-[#525363] border rounded outline-0 focus:border-[#68697a] p-2 mt-2 truncate cursor-pointer" onClick={() => {copyText(`${prodDomain}/d/auth/${method}`)}}>
