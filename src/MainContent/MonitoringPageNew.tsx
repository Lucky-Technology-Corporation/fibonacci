...
const MonitoringPageOld: React.FC = () => {
    ...
    useEffect(() => {
      ...
      const [selectedUniqueUsersDate, setSelectedUniqueUsersDate] = useState<number | null>(null);
      const [selectedTotalRequestsDate, setSelectedTotalRequestsDate] = useState<number | null>(null);
      ...
      const processDataAndCreateGraph = (chartdata, title, categories, selectedDate, setSelectedDate) => {
        return (
  ...
  return (
    <div className="overflow-scroll">
            ...
            {processDataAndCreateGraph(uniqueusersdata, "Unique Users", ["uniqueUsers"], selectedUniqueUsersDate, setSelectedUniqueUsersDate)}
            {processDataAndCreateGraph(totalrequestsdata, "Total Requests", ["totalRequests"], selectedTotalRequestsDate, setSelectedTotalRequestsDate)}
    </div>
  );
};
