...
export default function DocumentJSON({ document, collection, isVisible, setIsVisible, id, onChange }: { document: any | any[], collection: string, isVisible: boolean, setIsVisible: (isVisible: boolean) => void, id?: string, onChange: (data: any | any[]) => void }) {
