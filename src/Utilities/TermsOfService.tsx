export default function TermsOfService({app_name, company_name, company_address, contact_email}: {app_name: string, company_name: string, company_address: string, contact_email: string}){
    const date = new Date();
