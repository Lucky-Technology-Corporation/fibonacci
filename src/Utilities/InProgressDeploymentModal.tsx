        ...
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="bg-[#32333b] px-4 pt-5 pb-2 sm:p-6 sm:pb-4">
                ...
                <div className="mt-2">
                    ...
                    <li className="mt-2 ml-8">If this is a new project, your dashboard will be ready in ~5 minutes.<br/><br/>If this is an existing project, your test environment was put to sleep due to inactivity and will resume in ~2 minutes. <span className='font-medium text-green-500'>Your production environment is always available to customers.</span></li>
