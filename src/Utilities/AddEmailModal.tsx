              ...
              <div className="mt-2">
                ...
                <ul className="text-sm text-[#D9D9D9] no-focus-ring">
                  <input
                    ...
                    className="w-full bg-[#2D2E33] border-[#525363] border rounded p-2 my-1 text-sm m-auto"
                    placeholder="Email"
                  />
                  {/* Radio buttons */}
                  ...
                  <div className="flex items-center my-1">
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.checked) {
                          setProjectType("sideproject");
                        }
                      }}
                    />
                    <label htmlFor="sideproject" className="text-sm">
                      Side project
                    </label>
                  </div>
                  <div className="flex items-center my-1">
                  ...
                  <div className="flex items-center my-1">
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.checked) {
                          setProjectType("internaltool");
                        }
                      }}
                    />
                    <label htmlFor="internaltool" className="text-sm">
                      Internal Tool
                    </label>
                  </div>
                  <div className="flex items-center my-1">
