...
export default function IconTextButton({
  ...
  return (
    ...
    <Tooltip id="my-tooltip" className={`fixed z-50 ${!textHidden && "hidden"}`} />
      ...
      <Button
        className={`${className} w-full p-2 font-medium rounded flex justify-center items-center cursor-pointer ${highlightState ? "bg-["+highlightColor+"]" : "bg-[#85869833]"} hover:bg-[#85869855] border-[#525363] border`}
        onClick={onClick}
        text="Test"
      >
